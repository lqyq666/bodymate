...
createServer(async (request, response) => {
  ...
  const entry = pathname === '/' || pathname === '/prototype/original-scm/' ? '/prototype/original-scm/index.html' : pathname;
...
}).listen(port, () => console.log(`BodyMate original SCM: http://127.0.0.1:${port}/prototype/original-scm/`));
