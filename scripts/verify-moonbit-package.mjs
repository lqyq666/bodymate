...
with zipfile.ZipFile(sys.argv[1]) as archive:
    ...
    for entry in entries:
        ...
        if entry.is_dir():
            continue
        allowed = path in ['moon.mod', 'LICENSE', 'README.md'] or re.fullmatch(r'moonbit/(motion|examples)/[A-Za-z0-9_./-]+\\.(mbt|mbti|pkg|md)', path)
    ...
    required = ['moon.mod', 'LICENSE', 'moonbit/motion/moon.pkg', 'moonbit/motion/motion_test.mbt']
